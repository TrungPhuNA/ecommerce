...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="{!!  asset('backend')!!}/images/photo.jpg">
        <!-- Bootstrap -->
        ...
        <link href="{{ asset('backend/') }}/css/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
        <!-- Custom Theme Style -->
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        <a><i class="fa fa-sitemap"></i> Quản lý danh mục <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="{{ route('backend.category.add') }}">Thêm mới</a></li>
