        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form id="demo-form2"  class="form-horizontal form-label-left" novalidate="" method="POST">
                         {{ csrf_field() }}
                            ...
                            <div class="col-md-8 bor">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text"  required="required" name="name" class="form-control col-md-7 col-xs-12" value="{{ isset($producerEdit) ? $producerEdit['name'] : '' }}">
